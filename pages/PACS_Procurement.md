...
{% include alert-info.html content="When agencies are proceeding with acquisition of products and services for their HSPD12 implementation and are using other acquisition vehicles, instead of Schedule 70, they must ensure that the products they choose are only APPROVED products from the APL and meet Federal requirements and standards." %}
...
![13.01 PACS Topology](../img/pacs-buying_topology.JPG){:style="float:right"}
...
![PACS Buyer's Checklist Outline](../img/pacs-buying_checklist.JPG){:style="float:right"}
...
![navigating to FPKI Approved Providers](../img/pacs-buying_idm-9.JPG)
...
![FPKI Approved Providers page](../img/pacs-buying_idm-10.JPG)
